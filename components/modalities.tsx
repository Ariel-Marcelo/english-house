import {User, Users, Coffee, Medal} from "lucide-react"
        ...
        >
            ...
            <div className="relative mx-auto max-w-7xl px-6 z-10 w-full">
                ...
                <div className="mb-14 border-l-4 border-primary pl-6">
                    <h1 className="text-5xl md:text-7xl font-black font-serif text-primary tracking-tighter leading-none">
                        En Get Together,
                    </h1>
                    <p className="text-xl md:text-3xl font-extralight font-serif text-black italic tracking-tight">
                ...
                ${option.num === "01" ? 'bg-[#F36C21]/90' : ''}
                ${option.num === "02" ? 'bg-[#F36C21]/90' : ''}
                ${option.num === "03" ? 'bg-[#F36C21]/95 border-primary/30' : ''}
              `}
                        >
                            <div className="flex flex-col gap-5">
                                <div className="flex justify-between items-center">
                  <span className={`text-5xl font-black font-serif leading-none ${
                      option.num === "01" ? 'text-white' :
                          option.num === "02" ? 'text-white' : 'text-white'
                  }`}>
                    {option.num}
                  </span>
                                ...
                                <div>
                                    <h3 className="text-2xl font-bold text-primary font-serif leading-tight">
                                        {option.title}
                                    </h3>
                                    <p className="mt-3  leading-relaxed text-primary">
                                        {option.description}
                                    </p>
                                </div>
                            </div>
                ...
                <div
                    ...
                    <div className="flex items-center gap-4">
                        <Medal className="h-6 w-6 text-primary shrink-0"/>
                        <p className="text-xs md:text-sm text-black leading-relaxed max-w-2xl italic">
